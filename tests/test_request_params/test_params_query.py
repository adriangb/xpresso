...
def test_openapi_array() -> None:
    async def endpoint(query: FromQuery[List[int]]) -> Response:
        ...
...
def test_openapi_nullable_without_default() -> None:
    async def endpoint(query: FromQuery[Optional[int]]) -> Response:
        ...
...
def test_openapi_nullable_with_default() -> None:
    async def endpoint(query: FromQuery[Optional[int]] = None) -> Response:
        ...
...
def test_openapi_include_in_schema() -> None:
    async def endpoint(
        query: Annotated[str, QueryParam(include_in_schema=False)]
    ) -> None:
        ...
