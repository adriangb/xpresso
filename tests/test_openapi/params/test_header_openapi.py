...
from xpresso import App, FromHeader, HeaderParam, Path
...
def test_array() -> None:
    async def endpoint(header: FromHeader[typing.List[int]]) -> Response:
        ...
...
def test_nullable() -> None:
    async def endpoint(header: FromHeader[typing.Optional[int]]) -> Response:
        ...
